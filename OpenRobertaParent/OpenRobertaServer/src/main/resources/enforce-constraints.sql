...
alter table ROBOT alter column ID generated by default as identity (start with 1);
alter table PROGRAM alter column ID generated by default as identity (start with 1);
alter table USER_PROGRAM alter column ID generated by default as identity (start with 1);
alter table USER_PROGRAM_LIKE alter column ID generated by default as identity (start with 1);
alter table TOOLBOX alter column ID generated by default as identity (start with 1);
alter table CONFIGURATION alter column ID generated by default as identity (start with 1);
commit;
