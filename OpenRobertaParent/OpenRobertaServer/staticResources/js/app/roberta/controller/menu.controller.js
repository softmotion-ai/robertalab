define([ 'exports', 'log', 'util', 'message', 'comm', 'robot.controller', 'socket.controller', 'user.controller', 'user.model', 'guiState.controller',
        'cookieDisclaimer.controller', 'program.controller', 'program.model', 'progRun.controller', 'configuration.controller','import.controller', 'enjoyHint', 'tour.controller',
        ...
        CookieDisclaimer, PROGRAM_C, PROGRAM_M, RUN_C, CONFIGURATION_C,IMPORT_C, EnjoyHint, TOUR_C, SIM, PROGLIST, $, Blockly) {
